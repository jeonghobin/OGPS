					...
					<form class="login-form" method="POST" action="member/login">
						<div class="row m-1 mb-3">
							...
							<input type="text" class="form-control" id="login-user-id"
								name="login-user-id" placeholder="아이디: ssafy" />
						</div>
						<div class="row m-1 mb-3">
							<div class="d-flex justify-content-start ps-0">
								<i class="bi bi-patch-question me-1"></i> <label
							...
							<input type="password" class="form-control" id="login-password"
								placeholder="비밀번호: 1234" name="login-password" />
						</div>
					</form>
				</div>
		...
		<nav class="navbar navbar-light bg-light navbar-expand-lg">
			<div class="section-content p-1 mt-3 container-fluid">
				<a class="navbar-brand text-primary fw-bold"
					href="${root}/index.jsp"> <img src="${root}/img/trip-logo.png"
					alt="" width="130px" />
				</a>
				...
				<div class="collapse navbar-collapse" style="font-weight: bold"
					...
					<ul class="navbar-nav me-auto mb-lg-0">
						<li class="nav-item d-flex"><a class="nav-link"
							aria-current="page" href="${root}/attraction/attraction.jsp">전국
								관광지 정보</a> <a class="nav-link information-page" aria-current="page"
							href="${root}/board?action=information&pgno=1&key=&word=">공지사항</a></li>
					</ul>
