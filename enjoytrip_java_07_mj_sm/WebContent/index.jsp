    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active" data-interval="6000">
          ...
          <img src="./img/top2.1a2c46af.png" class="d-block w-100" alt="..." />
        ...
        <div class="carousel-item" data-interval="6000">
          <h2 class="carousel-up-text text-center">지금 Enjoy!!Trip 과 함께 우리지역의 관광지를 알아보고<br />나만의 여행 계획을 만들어보세요!!</h2>
          <img src="./img/top3.31d0592b.png" class="d-block w-100 h-75" alt="..." />
        ...
        <div class="carousel-item" data-interval="6000">
          <h2 class="carousel-up-text text-center">지금 Enjoy!!Trip 과 함께 우리지역의 관광지를 알아보고<br />나만의 여행 계획을 만들어보세요!!</h2>
          <img src="./img/top4.297ed701.png" class="d-block w-100" alt="..." />
          <div class="carousel-caption d-none d-md-block">
            <h5>신나는 여행 계획 세우고 공유해보세요!</h5>
            <button class="btn btn-primary">일정 더보기</button>
          </div>
        ...
        <div class="carousel-item" data-interval="6000">
          <h2 class="carousel-up-text text-center">지금 Enjoy!!Trip 과 함께 우리지역의 관광지를 알아보고<br />나만의 여행 계획을 만들어보세요!!</h2>
          <img src="./img/top5.bf00bcca.png" class="d-block w-100" alt="..." />
          <div class="carousel-caption d-none d-md-block">
            <h5>신나는 여행 계획 세우고 공유해보세요!</h5>
            <button class="btn btn-primary">일정 더보기</button>
          </div>
        ...
        <div class="carousel-item" data-interval="6000">
          <h2 class="carousel-up-text text-center">지금 Enjoy!!Trip 과 함께 우리지역의 관광지를 알아보고<br />나만의 여행 계획을 만들어보세요!!</h2>
          <img src="./img/top6.caa86eab.png" class="d-block w-100" alt="..." />
          <div class="carousel-caption d-none d-md-block">
            <h5>신나는 여행 계획 세우고 공유해보세요!</h5>
            <button class="btn btn-primary">일정 더보기</button>
          </div>
        ...
        <div class="carousel-item" data-interval="6000">
          <h2 class="carousel-up-text text-center">지금 Enjoy!!Trip 과 함께 우리지역의 관광지를 알아보고<br />나만의 여행 계획을 만들어보세요!!</h2>
          <img src="./img/top1.6220e4fc.png" class="d-block w-100" alt="..." />
          <div class="carousel-caption d-none d-md-block">
            <h5>신나는 여행 계획 세우고 공유해보세요!</h5>
            <button class="btn btn-primary">일정 더보기</button>
          </div>
