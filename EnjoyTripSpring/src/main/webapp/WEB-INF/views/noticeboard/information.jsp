...
<script>
	...
	titles.forEach(function (title) {
	  title.addEventListener("click", function () {
	    ...
	    location.href = "${root}/notice/view?article_no=" + this.getAttribute("data-no");
	  });
	});
	...
	document.querySelector("#write-button").addEventListener("click", function() {
		...
		if (state == "ok")
			document.querySelector("#write-button").href = "${root}/notice/write";
		else {
    ...
    pages.forEach(function (page) {
      page.addEventListener("click", function () {
        ...
        document.querySelector("#p-action").value = "${root}/notice/list";
