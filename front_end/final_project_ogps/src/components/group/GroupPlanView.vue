    ...
    <div>
        ...
        margin-left: 130px; margin-right: 130px; padding-top: 10px;">
            ...
            <div class="d-flex justify-content-center mt-5 mb-3">
                <button v-if="this.userInfo.userId===this.plan.userId" type="button" class="btn btn-info mr-2" style="border-radius:10px; font-size:25px;" @click="modifyplan">계획 수정</button>
...
export default {
    ...
    methods: {
        ...
        modifyplan(){
            this.$router.push({name:'groupplanmodify', params:{groupNo:this.groupNo,planNo:this.planNo}});
        }
    },
    computed:{
